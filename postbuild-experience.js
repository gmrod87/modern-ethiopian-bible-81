...
const extras=[];
if(!html.includes('/experience.js'))extras.push(`<script src="/experience.js?v=${release}"></script>`);
if(!html.includes('/ambient-audio.js'))extras.push(`<script src="/ambient-audio.js?v=${release}"></script>`);
if(!html.includes('/the81-theme.js'))extras.push(`<script src="/the81-theme.js?v=${release}"></script>`);
if(extras.length)html=html.replace('</body>',`  ${extras.join('\n  ')}\n</body>`);
