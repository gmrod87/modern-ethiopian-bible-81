module.exports=async function handler(req,res){
  ...
  try{
    ...
    const quickInstruction=quick?' VOICE MODE: answer in the very first sentence with no preamble. HARD LIMIT: never exceed 300 words. Aim for roughly 220–280 spoken words when the passage needs detail, and always finish with a complete sentence so the narration is never cut off.':'';
